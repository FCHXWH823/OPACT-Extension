...
typedef struct vars_t
{
	...
	vector<GRBVar> Probs;
	int nrb_ls, nac42_ls, nac32_ls, nfs_ls, nhs_ls, nfc_ls, nhc_ls; // number of bits sourced from the column at last stage
	int nrb, nac42, nac32, nF, nH; // number of compressors from the column at current stage
	vars_t()
	{
